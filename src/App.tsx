            ...
            <div className="App-instructions">
              ...
              <div className="App-instructions">
                <ol>
                  ...
                  <li>
                    ...
                    tree. It should capture just the original values and
              ...
              <div className="App-instructions">
                <ol>
                  ...
                  <li>
                    ...
                    after every element on the tree. (This can optionally
                    include the root node). When a user clicks the
                    <span role="img" aria-label="cross">
                      {" "}
                      ❌
                    </span>
              ...
              <div className="App-instructions">
                ...
                <ol>
                  ...
                  <li>
                    <i>
                      Bonus: Add a debouncer to only save the tree when it has
                      changed. [Show your work in a new commit.]
                    </i>
                  </li>
                  <li>
                    <i>
